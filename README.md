...
本项目研究如何将 OpenClash 设置为效率、安全和省心三者兼顾的完美状态，零基础小白也能轻松看懂。  
...
## 更新  
本项目模板包含的规则均为引用的上游规则碎片，上游规则更新与本项目模板的更新没有直接关系，只需根据方案设置每日更新订阅即可每日自动获取最新规则。  

2024.9.29  
完善广告拦截设置的部分。  

2024.9.27  
更新部分示意图。现在建议启用“使用规则集”功能。（感谢 [bdingtech](https://github.com/bdingtech) 的建议）    

2024.9.15  
根据 OpenClash v0.46.029-beta 的界面改动，更新部分示意图。  

2024.9.7  
根据 OpenClash v0.46.024-beta 的界面改动，更新部分示意图。  
