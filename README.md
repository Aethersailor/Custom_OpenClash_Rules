...
> 2. 本项目中的内容仅用于学习与研究目的，不得将其用于任何可能违反国家、地区或组织法律法规的用途，特别是不得在中华人民共和国境内用于获取、传播被依法阻断来源于境外的违法信息。
> 3. 任何直接或间接使用本项目的个人或组织，应在 24 小时内完成学习与研究，随后删除所有相关内容。使用者在使用期间产生的任何法律责任均与本项目维护者无关，因其使用导致的任何后果均由使用者自行承担。
> 4. 使用本项目内容进行的任何更改，均为其他个人或组织的行为，与本项目及其维护者无关，因其修改导致的任何后果由相关责任方承担。
> 5. 本项目不鼓励他人对本项目内容进行任何形式的转载和二次创作，包括但不限于文章、视频等形式，更不得将相关内容转载于中华人民共和国境内的任何互联网平台之上。由转载和二次创作导致的法律责任与本项目维护者无关。
...
> [!WARNING]
> ⚠️ **维护者和推荐机场无任何关系**。  
> ⚠️ **维护者仅作推荐，不对机场服务质量产生的问题承担任何责任。**  
> ⚠️ **购买并使用任何机场前，请自行评估风险。**  
...
> **节点过滤建议：**
>
> 该机场 Hong Kong 11-15 节点以及其他部分节点暂不支持 IPv6 出站，如果需要使用 IPv6 出站功能，建议在 `订阅设置 > 排除节点` 中设置排除如下关键词，以避免使用非 IPv6 出站节点：
>
> ```text
