...
此处也提供本仓库订阅模板的单独下载地址：  
https://raw.githubusercontent.com/seeson/Custom_OpenClash_Rules/refs/heads/main/cfg/Custom_Clash.ini
...
如果百度之类的热门网站出现分流不正常，说明你的 OpenClash 工作不正常，请检查你的设置情况，必要时请还原设置重新配置。  
如果你认为相关规则出现了分流不正常检查设置，然后自行检索规则相关策略组引用的规则，然后至对应项目的仓库反馈。  
