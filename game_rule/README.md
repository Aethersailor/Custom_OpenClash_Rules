...
本目录存放手工整理的游戏 IP 规则。它们是独立的 Classical YAML Rule Provider，不会被主配置、`rule/` 生成器或 GitHub Actions 自动加载和更新。

| 文件 | 游戏与范围 | 来源 |
| --- | --- | --- |
| [`Microsoft-Flight-Simulator-2020.yaml`](Microsoft-Flight-Simulator-2020.yaml) | 《微软模拟飞行 2020》，全区服 | 从 UU 加速器规则整理 |
| [`Overwatch2_Asia(Singapore).yaml`](Overwatch2_Asia%28Singapore%29.yaml) | 《守望先锋 2》，亚服（新加坡） | 使用 SSTAP_ip_crawl_tool 抓取并整理 |
