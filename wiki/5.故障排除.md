...
**如何方便地在每次升级后更新 dev 版本的 OpenClash**：参考以下内容：[升级插件至 Dev 版本](9.其他说明.md#openclash-dev-upgrade)
...
> [!NOTE]
> 很多人觉得官方发布的固件容量不够用  
> 官方发布版固件可以借助 owut 持久记录目标根文件系统大小，但首次改变分区大小仍存在丢失配置的风险。操作前务必备份并确认恢复路径。[扩容教程](7.一些零碎的教程.md#firmware-expansion)
