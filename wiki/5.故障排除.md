...
> * 官方发布版固件可以很方便的借助 owut 实现扩容，不影响升级。[扩容教程](7.一些零碎的教程.md#firmware-expansion)
...
> [!NOTE]
> 很多人觉得官方发布的固件容量不够用  
> 官方发布版固件可以很方便的借助 owut 实现永久扩容，不影响升级。且操作简单到有手就行，不需要使用网上任何复杂的扩容教程。[扩容教程](7.一些零碎的教程.md#firmware-expansion)
