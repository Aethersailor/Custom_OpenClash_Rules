...
ImmortalWrt 软件源中的 `subconverter` 软件包是传统 subconverter，不是 [SubConverter-Extended](https://github.com/Aethersailor/SubConverter-Extended)。两者的功能、接口扩展和维护节奏可能不同；本节只说明软件源中的传统 subconverter。需要 SubConverter-Extended 功能时，请按照该项目的部署文档另行安装。
