...
(
    ...
    curl -sS -4 -L --retry 10 --retry-delay 2 "https://github.boki.moe/https://raw.githubusercontent.com/Aethersailor/adblockfilters-modified/refs/heads/main/rules/adblockdnsmasq.txt" \
